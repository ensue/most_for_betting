...
4. **`research/`** — structured theses and **logged fair probability estimates** for events the user analyzed. When a bet plan references research, the numbers in `research/` beat chat memory.
...
- **Research:** If the user built a thesis in `research/`, use that file's **fair probability** and **sources** before improvising new numbers in chat.
